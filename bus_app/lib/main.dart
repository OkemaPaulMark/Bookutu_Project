  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedLabelStyle:
            TextStyle(fontWeight: FontWeight.bold), // Selected label style
        unselectedLabelStyle:
            TextStyle(fontWeight: FontWeight.normal), // Unselected label style
        showSelectedLabels: true, // Always show selected label
        showUnselectedLabels: true, // Show labels for unselected items
        type: BottomNavigationBarType
            .fixed, // Important if you have more than 3 items
        items: const [
