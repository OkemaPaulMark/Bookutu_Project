...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    user_type = models.CharField(
        max_length=20, choices=USER_TYPE_CHOICES, default="COMPANY_STAFF", blank=True
    )
    ...
    def save(self, *args, **kwargs):
        # If no company and no user_type specified, this is likely a passenger/guest user
        # Set company to None for non-staff users
        if not self.company and self.user_type not in ["COMPANY_STAFF", "SUPER_ADMIN"]:
            pass  # Passenger or guest user - no company needed
        ...
        # Super admins and non-staff users should not have a company
