...
class RouteForm(forms.ModelForm):
    ...
    class Meta:
        model = Route
        fields = [
            'name', 'origin_city', 'origin_terminal', 'destination_city', 'destination_terminal',
            'distance_km', 'estimated_duration_hours', 'base_fare', 'is_active', 'intermediate_stops'
        ]
        widgets = {
            ...
            'origin_terminal': forms.TextInput(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
            ...
            'destination_terminal': forms.TextInput(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
            ...
            'intermediate_stops': forms.Textarea(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'rows': 3,
...
class TripForm(forms.ModelForm):
    ...
    class Meta:
        model = Trip
        fields = [
            'route', 'bus', 'departure_date', 'departure_time', 'arrival_time',
        ...
        widgets = {
            ...
            'conductor_name': forms.TextInput(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'placeholder': 'Conductor Name (Optional)'
            }),
            'conductor_phone': forms.TextInput(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
...
class TripPricingForm(forms.ModelForm):
    ...
    class Meta:
        model = TripPricing
        fields = [
            'peak_season_multiplier', 'demand_multiplier', 'early_bird_discount',
            'early_bird_days'
        ]
        widgets = {
            'peak_season_multiplier': forms.NumberInput(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'min': '0.1',
                'step': '0.01',
                'placeholder': '1.00'
            }),
            'demand_multiplier': forms.NumberInput(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'min': '0.1',
                'step': '0.01',
                'placeholder': '1.00'
            }),
            'early_bird_discount': forms.NumberInput(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'min': '0',
                'max': '1',
                'step': '0.01',
            ...
            'early_bird_days': forms.NumberInput(attrs={
                'class': 'w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500',
                'min': '1',
                'max': '30',
                'placeholder': '7'
