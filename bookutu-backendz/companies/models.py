...
class BusSeat(models.Model):
    ...
    # Pricing
    price_multiplier = models.DecimalField(max_digits=3, decimal_places=2, default=1.00)  # 1.0 = base price, 1.5 = 50% more
...
class CompanySettings(models.Model):
    ...
    # Booking Settings
    advance_booking_days = models.PositiveIntegerField(default=30)  # How many days in advance can customers book
    cancellation_hours = models.PositiveIntegerField(default=24)  # Hours before departure for free cancellation
    cancellation_fee_percentage = models.DecimalField(max_digits=5, decimal_places=2, default=10.00)
