...
from .mobile_serializers import (
    MobileUserSerializer, MobileTripSearchSerializer, MobileTripSerializer,
    MobileBookingCreateSerializer, MobileBookingSerializer, MobileSeatSerializer,
...
def search_trips(request):
    ...
    trips = Trip.objects.filter(
        ...
        status='SCHEDULED'
    ).select_related('company', 'route', 'bus').prefetch_related('bus__seats')
    ...
    return Response({
        ...
        'total_found': len(available_trips)
    })
...
def trip_details(request, trip_id):
    ...
    seat_data = MobileSeatSerializer(seats, many=True).data
...
class MobileBookingListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        ).select_related('trip__company', 'trip__route', 'seat').order_by('-created_at')
...
def update_profile(request):
    ...
    if hasattr(user, 'passenger_profile'):
        ...
        profile.preferred_payment_method = data.get('preferred_payment_method', profile.preferred_payment_method)
        profile.save()
