...
def generate_ticket(booking, format="digital"):
    ...
    ticket_data = {
        ...
        "bus_registration": booking.trip.bus.license_plate,
    ...
    if format == "print":
        ...
        ticket_data["print_format"] = {
            ...
            "seat_line": f"Seat: {booking.seat.seat_number} | Bus: {booking.trip.bus.license_plate}",
...
Bus: {booking.trip.bus.license_plate}
...
""".strip()
    ...
    try:
        ...
        response = requests.post(
            ...
            json={"to": booking.passenger_phone, "message": message, "from": "BOOKUTU"},
            timeout=10,
        )
